...
const Header: React.FC = () => {
  return (
    <>
      <header>
        <div className="container mx-auto min-h-[6x0px] py-1 px-4 flex flex-row items-center justify-between mt-[1vh] bg-white border-1 border-black rounded-2xl">
          <img src="/logo.svg" />
          <DesktopMenu />
          <div className="account flex flex-row gap-2 items-center">
            <img className="avatar" src="/avatar.png" />
            <div className="flex flex-col text-sm">
              <span className="w-full font-bold">Dr. Jose Simmons</span>
              <span className="w-full font-thin">General Practitioner</span>
            </div>
            <SettingsIcon />
            <ElipsesIcon />
          </div>
